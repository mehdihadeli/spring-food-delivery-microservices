...
// @Component, @Service
@SpringBootApplication(scanBasePackageClasses = {CatalogsCoreRoot.class, CatalogsApiRoot.class})
...
@AutoConfigurationPackage(
        ...
        basePackageClasses = {CatalogsCoreRoot.class, CatalogsApiRoot.class})
