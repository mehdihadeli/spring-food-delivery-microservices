package com.github.mehdihadeli.identity.api;
...
import com.github.mehdihadeli.identity.core.AppProperties;
import com.github.mehdihadeli.identity.core.IdentityCoreRoot;
...
// @Component, @Service
@SpringBootApplication(scanBasePackageClasses = {IdentityCoreRoot.class})
...
@AutoConfigurationPackage(
        ...
        basePackageClasses = {IdentityCoreRoot.class})
...
public class IdentityApiApplication {
    ...
    private static final Logger logger = LoggerFactory.getLogger(IdentityApiApplication.class);

    public static void main(String[] args) {
        logger.atInfo().addKeyValue("app-name", Constants.APP_NAME).log("Starting {} application.", Constants.APP_NAME);

        SpringApplication app = new SpringApplication(IdentityApiApplication.class);
