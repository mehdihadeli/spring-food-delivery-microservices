...
// ref:
// https://github.com/thomasdarimont/keycloak-project-example/blob/main/apps/bff-springboot3/src/main/java/com/github/thomasdarimont/apps/bff3/oauth/TokenRefresher.java
...
public class TokenRefresher {
    ...
    public OAuth2AccessToken refreshTokens(OAuth2AuthorizedClient client) {
        ...
        var responseEntity =
                rt.postForEntity(tokenUri, new HttpEntity<>(requestBody, headers), AccessTokenResponse.class);
        ...
        var newOAuth2AccessToken = new OAuth2AccessToken(
                OAuth2AccessToken.TokenType.BEARER, newAccessTokenValue, accessTokenIat, accessTokenExp);
        ...
        var newClient = new OAuth2AuthorizedClient(
                clientRegistration, client.getPrincipalName(), newOAuth2AccessToken, newOAuth2RefreshToken);
        authorizedClientService.saveAuthorizedClient(
                newClient, SecurityContextHolder.getContext().getAuthentication());
