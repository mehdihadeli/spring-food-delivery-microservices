...
import com.github.mehdihadeli.buildingblocks.abstractions.core.data.IAggregateDataModelBase;
...
@MappedSuperclass
public abstract class AggregateDataModelBase<TId extends Serializable> extends EntityDataModelBase<TId>
        implements IAggregateDataModelBase<TId> {
